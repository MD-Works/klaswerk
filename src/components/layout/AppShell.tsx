...
// KlasWerk â€” App Shell Layout
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Authenticated layout: sidebar nav + top bar + content
// Session 8: full mobile-responsive overhaul
//   â€¢ Mobile (<768px): sidebar collapses to off-canvas drawer
//   â€¢ Hamburger toggle in top-bar
//   â€¢ Backdrop overlay closes drawer on tap-outside
//   â€¢ Content shifts right only on desktop (margin-left: 220px)
//   â€¢ All padding/font sizes fluid for small screens
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
// â”€â”€ Hook: detect mobile viewport â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Sidebar content (shared between desktop fixed + mobile drawer) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {isOwner ? 'Owner Portal' : isTrainer ? 'Trainer Portal' : 'Student Portal'}
        </div>
      </div>
...
export function AppShell({ children }: { children: React.ReactNode }) {
  const { profile, isTrainer, isOwner, isReady, signOut } = useAuth()
  ...
  if (!isReady) return (
    <div style={{
      ...
      minHeight: "100vh", color: "var(--kw-muted)",
      fontFamily: "Syne Mono, monospace", fontSize: "0.7rem", letterSpacing: "0.15em",
    }}>
      <span className="kw-spinner" style={{ marginRight: "0.6rem" }} /> LOADING...
    </div>
  )
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', position: 'relative' }}>
      ...
      {/* â•â• DESKTOP SIDEBAR (fixed, always visible â‰¥768px) â•â• */}
      {!isMobile && (
        <aside style={{
          width: '220px',
          flexShrink: 0,
      ...
      {/* â•â• MOBILE DRAWER (slides in from left) â•â• */}
      {isMobile && (
        <aside
          ref={drawerRef}
          style={{
      ...
      <main style={{
        ...
        <header style={{
          ...
          <span className="kw-badge kw-badge-gold" style={{ textTransform: 'uppercase', fontSize: '0.58rem' }}>
            {isOwner ? 'Owner' : isTrainer ? 'Trainer' : 'Student'}
          </span>
